...
# track_path = 'examples/audio/track02_cormac_begley_start.mp3'

# try:
#     # Load the audio with specific offset and duration
#     y, sr = librosa.load(track_path, offset=40, duration=10)
# except Exception as e:
#     print(f"Error loading audio: {e}")
#     # Fallback to loading the entire track if there's an error
